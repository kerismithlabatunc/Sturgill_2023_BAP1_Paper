...
uvm_mat <- counts(uvm_dds, normalized = TRUE)
...
uvm_hallmark_mat <- counts(uvm_dds, normalized = TRUE)
...
lihc_mat <- counts(lihc_dds, normalized = TRUE)
...
# Instead of variably expressed genes, now we specifically look at genes from hallmark sets
lihc_hallmark_mat <- counts(lihc_dds, normalized = TRUE)
...
mat <- counts(combined_dds, normalized = TRUE)
...
ha <- HeatmapAnnotation(cancer_type = coldata$project, purity = coldata$purity, 
                          ...
                          col = list(cancer_type = tcga_col[names(tcga_col) %in%
                                                              coldata$project],
                                     purity = pal_purity,
                                     alteration_type = c("copynumber" = "lightgreen", 
                                                         "mutation" = "salmon",
...
kirc_mat <- counts(kirc_dds, normalized = TRUE)
